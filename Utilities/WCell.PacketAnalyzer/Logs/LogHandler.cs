...
namespace WCell.PacketAnalysis.Logs
{
    public class LogHandler
    {
        ...
        public LogHandler(OpCodeValidator validator, Action<PacketParser> packetHandler)
            : this(validator, null, packetHandler, null)
        {
        }
        ...
        public LogHandler(Action<ParsedUpdatePacket> updatePacketHandler)
            : this(opcode => opcode.IsUpdatePacket, updatePacketHandler)
        {
        }

        public LogHandler(OpCodeValidator validator, Action<ParsedUpdatePacket> updatePacketHandler)
            : this(validator, null, updatePacketHandler)
        {
        }
