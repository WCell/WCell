...
namespace WCell.PacketAnalysis.Samples
{
    public class TrainerInfoExtractor
    {
        ...
        private static void HandleTrainerList(PacketParser parser)
        {
        ...
        private static void HandleInitFactions(PacketParser parser)
        {
        ...
        private static void UpdateReputations(PacketParser parser)
        {
        ...
        private static void HandleUpdates(ParsedUpdatePacket packet)
        {
        ...
        private static ReputationInfo GetInfo(FactionReputationIndex index)
        {
            ReputationInfo rep;
