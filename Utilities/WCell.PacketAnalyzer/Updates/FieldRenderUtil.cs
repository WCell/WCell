...
namespace WCell.PacketAnalysis.Updates
{
	...
	public static class FieldRenderUtil
	{
		...
		static void Set<T>(Dictionary<object, T> map, T val, object startField, uint fieldCount)
		{
		...
		static FieldRenderer CreateRenderer(ObjectTypeId enumType)
		{
		...
		static void InitValuesAndTypes()
		{
		...
		static void AddValues(ObjectTypeId objectType, ObjectTypeId includedEnumType)
		{
			object[] included;
		...
		static void InitCustomRenderers()
		{
		...
		static void SetupObjectRenderers()
		{
		...
		static void SetupItemRenderers()
		{
		...
		static void SetupUnitRenderers()
		{
		...
		static void SetupPlayerRenderers()
		{
		...
		static void SetupGameObjectRenderers()
		{
		...
		static void SetupDynamicObjectRenderers()
		{

		}

		static void SetupCorpseRenderers()
		{
