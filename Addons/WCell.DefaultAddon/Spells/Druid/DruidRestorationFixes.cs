		...
		public static void FixIt()
		{
			...
			SpellLineId.DruidRestorationOmenOfClarity.Apply(spell =>
			{
				...
				effect.AddToAffectMask(
					...
					SpellLineId.DruidRestorationWildGrowth,
					SpellLineId.DruidBalanceTyphoon, SpellLineId.DruidWrath,
					...
					SpellLineId.DruidPounce, SpellLineId.DruidShred, SpellLineId.DruidBash,
					...
					SpellLineId.DruidLifebloom, SpellLineId.DruidMaim);
			});
