...
namespace WCell.Addons.Default.Spells
{
    ...
    public static class PlayerSpells
    {
        ...
        static void FixRacials()
        {
            ...
            SpellLineId.SecondarySkillEscapeArtistRacial.Apply(spell =>
            {
        ...
        public class EscapeArtistEffectHandler : SpellEffectHandler
        {
            ...
            protected override void Apply(WorldObject target)
            {
                ...
                HashSet<AuraType> movementAndSpeedImpairingTypes = new HashSet<AuraType>();
                movementAndSpeedImpairingTypes.Add(AuraType.ModDecreaseSpeed);
                movementAndSpeedImpairingTypes.Add(AuraType.ModRoot);

                character.Auras.RemoveWhere(aura => aura.Handlers.Any(handler => movementAndSpeedImpairingTypes.Contains(handler.SpellEffect.AuraType)));
            }
        };
        #endregion
        #endregion
