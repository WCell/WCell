    ...
    class Ironforge : GossipMenu
    {
        ...
        public static void CreateIronforgeGossipMenu()
        {
            ...
            entry.DefaultGossip = new GossipMenu(
                new GossipMenuItem(GossipMenuIcon.Talk, "Auction House",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -4597.39f, -911.6f, 7,7, "Ironforge Auction House")),
                new GossipMenuItem(GossipMenuIcon.Talk, "Bank of Ironforge",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -4891.9f, -991.47f, 7,7, "The Vault")),
                new GossipMenuItem(GossipMenuIcon.Talk, "Deeprun Tram",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -4835.27f,-1294.69f,  7,7, "The Deeprun Tram")),
                new GossipMenuItem(GossipMenuIcon.Talk, "Gryphon Master",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -4821.52f, -1152.3f, 7,7, "Ironforge Gryphon Master")),
                new GossipMenuItem(GossipMenuIcon.Talk, "Guild Master",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -5021f, -996.45f, 7, 7,"Ironforge Visitor's Center")),
                new GossipMenuItem(GossipMenuIcon.Talk, "The Inn",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -4850.47f, -872.57f, 7,7, "Stonefire Tavern")),
                new GossipMenuItem(GossipMenuIcon.Talk, "The Mailbox",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -4845.7f, -880.55f, 7,7, "Ironforge Mailbox")),
                new GossipMenuItem(GossipMenuIcon.Talk, "Stable Master",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -5010f, -1262f, 7, 7,"Ulbrek Firehand")),
                new GossipMenuItem(GossipMenuIcon.Talk, "Weapons Trainer",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -5040f, -1201.88f, 7,7, "Bixi and Buliwyf")),
                new GossipMenuItem(GossipMenuIcon.Talk, "The Battlemaster",convo =>GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.Six, -5047.87f,-1263.77f, 7, 7, "Battlemasters Ironforge")),
                new GossipMenuItem("A Class Trainer",
                    new GossipMenu(
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Druid",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.Six, -8737.481f,-1058.529f, 7, 7, "The Park")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Hunter",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.Six, -8423.877f,-552.1997f, 7, 7, "Hunter Lodge")),
