        ...
        public static void CreateIronforgeGossipMenu()
        {
            ...
            entry.DefaultGossip = new GossipMenu(
                ...
                new GossipMenuItem("A Profession Trainer",new GossipMenu(new GossipMenuItem(GossipMenuIcon.Talk, "Alchemy",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4858.5f, -1241.83f, 7,"Berryfizz's Potions and Mixed Drinks")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Blacksmithing",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4796.97f, -1110.17f, 7,"The Great Forge")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Cooking",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4767.83f, -1184.59f, 7,"The Bronze Kettle")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Enchanting",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4803.72f, -1196.53f, 7,"Thistlefuzz Arcanery")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Engineering",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4799.56f, -1250.23f, 7,"Springspindle's Gadgets")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "First Aid",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4881.6f, -1153.13f, 7,"Ironforge Physician")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Fishing",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4597.91f, -1091.93f, 7,"Traveling Fisherman")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Herbalism",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4881.9f, -1151.92f, 7,"Ironforge Physician")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Leatherworking",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None, -4745f,-1027.57f, 7,"Finespindle's Leather Goods")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Mining",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4705.06f, -1116.43f, 7,"Deepmountain Mining Guild")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Skinning",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None, -4745f,-1027.57f, 7,"Finespindle's Leather Goods")),
                                       new GossipMenuItem(GossipMenuIcon.Talk, "Tailoring",convo =>GossipHandler.SendGossipPOI(convo.Character,GossipPOIFlags.None,-4719.60f, -1057f, 7,"Stonebrow's Clothier"))
                                 )
                    ));
        }
    }
