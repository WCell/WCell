            ...
            new GossipMenuItem("Class Trainer",
                               new GossipMenu(
                                   ...
                                   new GossipMenuItem(GossipMenuIcon.Talk, "Hunter",
                                                      convo =>
                                                      GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.None, 10178.57f, 2510.957f, 7,
                                                                                  "Darnassus Hunter Trainer")),
                                   new GossipMenuItem(GossipMenuIcon.Talk, "Mage",
                                                      convo =>
                                                      GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.None, 9664.587f, 2528.172f, 7,
                                                                                  "Darnassus Mage Trainer")),
                                   new GossipMenuItem(GossipMenuIcon.Talk, "Paladin",
                                                      convo =>
                                                      GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.None, 9964.599f, 2529.992f, 7,
                                                                                  "Darnassus Paladin Trainer")),
                                   new GossipMenuItem(GossipMenuIcon.Talk, "Priest",
                                                      convo =>
                                                      GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.None, 9667.163f, 2532.749f, 7,
                                                                                  "The Temple The Moon")),
                                   new GossipMenuItem(GossipMenuIcon.Talk, "Rogue",
                                                      convo =>
                                                      GossipHandler.SendGossipPOI(convo.Character, GossipPOIFlags.None, 10124f, 2592.819f, 7,
