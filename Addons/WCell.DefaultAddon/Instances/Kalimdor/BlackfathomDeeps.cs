	...
	public class BlackfathomDeeps : RaidInstance
	{
		...
		public class SarevessAttackAction : AIAttackAction
		{
			...
			public static void InitLadySpells()
			{
			    ...
			    forkedLightning.SpellTargetRestrictions = new SpellTargetRestrictions {MaxTargets = 1};
				...
				var slow = SpellHandler.Get(SpellId.Slow);
				slow.AISettings.SetCooldownRange(13000);
                slow.SpellTargetRestrictions = new SpellTargetRestrictions { MaxTargets = 1 };
				...
				var frostNova = SpellHandler.Get(SpellId.ClassSkillFrostNova);
			...
			public SarevessAttackAction(NPC LadySarevess)
				: base(LadySarevess)
			{
				LadySarevess.Spells.AddSpell(SpellId.ForkedLightningRank1, SpellId.Slow, SpellId.ClassSkillFrostNova);
			}
		...
		public class GelihastAttackAction : AIAttackAction
		{
			...
			public static void InitGelihast()
			{
                ...
                net.SpellTargetRestrictions = new SpellTargetRestrictions { MaxTargets = 1 };
