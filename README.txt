...
After downloading please follow the Basic Setup guide at http://wiki.wcell.org/index.php/Basic_Setup
If you are looking for some random bits and pieces about the project feel free to brwose our wiki at http://wiki.wcell.org/
...
WCell's strong points are:
- Very powerful subsystems (see http://wiki.wcell.org/index.php?title=WCell_API for a simple overview over the API)
	- Spells: http://wiki.wcell.org/index.php?title=API:Spells
	- Instances: http://wiki.wcell.org/index.php?title=API:Instances
	- Battlegrounds: http://wiki.wcell.org/index.php?title=API:Battlegrounds
