	...
	public class CustomType : AbstractType, IDiscriminatorType, IVersionType
	{
	    ...
	    public bool Equals(CustomType other)
	    {
	        ...
	        if (ReferenceEquals(this, other))
	            return true;
	        return base.Equals(other) && Equals(other.userType, userType) && Equals(other.name, name) && Equals(other.sqlTypes, sqlTypes);
	    }
	    ...
	    public override int GetHashCode()
	    {
	        unchecked
	        {
	            ...
	            result = (result * 397) ^ (userType != null ? userType.GetHashCode() : 0);
	            result = (result * 397) ^ (name != null ? name.GetHashCode() : 0);
	            result = (result * 397) ^ (sqlTypes != null ? sqlTypes.GetHashCode() : 0);
	            return result;
	        }
	    }
	}
