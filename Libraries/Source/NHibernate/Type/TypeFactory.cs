...
namespace NHibernate.Type
{
	...
	{
		static readonly ILog log = LogManager.GetLogger(typeof(TypeFactory));
		...
		public static IType HeuristicType(string typeName, IDictionary parameters)
		{
			...
			if (type == null)
			{
				...
				{
					throw new ArgumentException("Invalid Type: " + parsedTypeName[0], e);
				}
				type = GetMetaType(typeClass, parameters);
			}
			return type;
		}

		public static IType GetMetaType(System.Type typeClass)
		{
			return GetMetaType(typeClass, null);
		}
		...
		public static Boolean IsNullableEnum(System.Type typeClass)
		{
