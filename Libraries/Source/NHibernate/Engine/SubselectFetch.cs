...
namespace NHibernate.Engine
{
	public class SubselectFetch
	{
		...
		private readonly Iesi.Collections.Generic.ISet<EntityKey> resultingEntityKeys;

		public SubselectFetch(string alias, ILoadable loadable, QueryParameters queryParameters,
		                      Iesi.Collections.Generic.ISet<EntityKey> resultingEntityKeys, IDictionary<string, int[]> namedParameterLocMap)
		{
		...
		public Iesi.Collections.Generic.ISet<EntityKey> Result
		{
