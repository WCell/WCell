...
namespace NHibernate.Util
{
	...
	{
		[Serializable]
		protected class Entry<TEKey, TEValue>
		{
			private readonly TEKey key;
			private TEValue evalue;
			private Entry<TEKey, TEValue> next = null;
			private Entry<TEKey, TEValue> prev = null;

			public Entry(TEKey key, TEValue value)
			{
				this.key = key;
				evalue = value;
			}
			...
			public Entry<TEKey, TEValue> Next
			{
				get { return next; }
				set { next = value; }
			}

			public Entry<TEKey, TEValue> Prev
			{
				get { return prev; }
				set { prev = value; }
			}
