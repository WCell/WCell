...
namespace NHibernate.Impl
{
	...
	public sealed class SessionFactoryImpl : ISessionFactoryImplementor, IObjectReference
	{
		...
		[NonSerialized] private readonly IDictionary<string, Iesi.Collections.Generic.ISet<string>> collectionRolesByEntityParticipant;
		...
		public SessionFactoryImpl(Configuration cfg, IMapping mapping, Settings settings, EventListeners listeners)
		{
			...
			Dictionary<string, Iesi.Collections.Generic.ISet<string>> tmpEntityToCollectionRoleMap = new Dictionary<string, Iesi.Collections.Generic.ISet<string>>();
			...
			foreach (Mapping.Collection model in cfg.CollectionMappings)
			{
				...
				if (indexType != null && indexType.IsAssociationType && !indexType.IsAnyType)
				{
					...
					Iesi.Collections.Generic.ISet<string> roles;
			...
			collectionRolesByEntityParticipant = new UnmodifiableDictionary<string, Iesi.Collections.Generic.ISet<string>>(tmpEntityToCollectionRoleMap);
			#endregion
		...
		{
			Iesi.Collections.Generic.ISet<string> result;
