...
namespace Castle.ActiveRecord.Framework
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ActiveRecordException"/> class.
		/// </summary>
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ActiveRecordInitializationException"/> class.
		/// </summary>
		/// <param name="message">The message.</param>
