...
namespace Castle.ActiveRecord
{
	...
	public static class ActiveRecordStarter
	{
		...
		/// <returns></returns>
		public static SchemaExport CreateSchemaExport(Configuration cfg)
		{
		...
		public static void CollectValidActiveRecordTypesFromAssembly(Assembly assembly, ICollection<Type> list,
		                                                              IConfigurationSource source)
		{
