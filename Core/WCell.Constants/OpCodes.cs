...
namespace WCell.Constants
{
    ...
    public enum RealmServerOpCode : uint
    {
        ...
        UMSG_UNKNOWN_1227 = 0x4CB,
        UMSG_UNKNOWN_1228 = 0x4CC,
        ...
        UMSG_UNKNOWN_1239 = 0x4D7,
        SMSG_UNKNOWN_1240 = 0x4D8,
        CMSG_CHAR_FACTION_CHANGE = 0x4D9,
        SMSG_CHAR_FACTION_CHANGE = 0x4DA,
        UMSG_UNKNOWN_1243 = 0x4DB,
        UMSG_UNKNOWN_1244 = 0x4DC,
        UMSG_UNKNOWN_1245 = 0x4DD,
        ...
        UMSG_UNKNOWN_1257 = 0x4E9,
        UMSG_UNKNOWN_1258 = 0x4EA,
        MSG_SET_RAID_DIFFICULTY = 0x4EB,
        UMSG_UNKNOWN_1260 = 0x4EC,
        ...
        UMSG_UNKNOWN_1266 = 0x4F2,
        UMSG_UNKNOWN_1267 = 0x4F3,
        UMSG_UNKNOWN_1268 = 0x4F4,
        ...
        UMSG_UNKNOWN_1299 = 0x513,
        SMSG_COMBAT_LOG_MULTIPLE = 0x514,
        SMSG_LFG_OPEN_FROM_GOSSIP = 0x515,
        SMSG_MOVE_UNKNOWN_1302 = 0x516,
        CMSG_MOVE_UNKNOWN_1303 = 0x517,
        SMSG_MOVE_UNKNOWN_1304 = 0x518,
        UMSG_UNKNOWN_1305 = 0x519,
        UMSG_UNKNOWN_1306 = 0x51A,
        CMSG_COMMENTATOR_SET_SKIRMISH_MATCHMAKING_MODE = 0x51B,
        CMSG_COMMENTATOR_SKIRMISH_QUEUE_REQUEST = 0x51C,
        CMSG_REQUEST_TRANSFORM = 0x51D,
        SMSG_CANNOT_TRANSFORM = 0x51E,
        SMSG_UNKNOWN_1311 = 0x51F,
        SMSG_ALLOW_TRANSFORM = 0x520,
        UMSG_UNKNOWN_1313 = 0x521,
        SMSG_UNKNOWN_1314 = 0x522,
        SMSG_UNKNOWN_1315 = 0x523,
        SMSG_UNKNOWN_1316 = 0x524,
        SMSG_UNKNOWN_1317 = 0x525,
        UMSG_UNKNOWN_1318 = 0x526,
        UMSG_UNKNOWN_1319 = 0x527,
        SMSG_SET_CURRENCY = 0x528,
        UMSG_UNKNOWN_1321 = 0x529,
        UMSG_UNKNOWN_1322 = 0x52A,
        UMSG_UNKNOWN_1323 = 0x52B,
        UMSG_UNKNOWN_1324 = 0x52C,
        UMSG_UNKNOWN_1325 = 0x52D,
        UMSG_UNKNOWN_1326 = 0x52E,
        UMSG_UNKNOWN_1327 = 0x52F,
        UMSG_UNKNOWN_1328 = 0x530,
        SMSG_UNKNOWN_1329 = 0x531,
        UMSG_UNKNOWN_1330 = 0x532,
        UMSG_UNKNOWN_1331 = 0x533,
        UMSG_UNKNOWN_1332 = 0x534,
        UMSG_UNKNOWN_1333 = 0x535,
        UMSG_UNKNOWN_1334 = 0x536,
        Maximum = 0x537,
        Unknown,
    }
