...
namespace WCell.Constants.Spells
{
    ...
    public static class SpellEnumExtensions
    {
        ...
        public static bool Has(this AuraFlags flags, AuraFlags toCheck)
        {
            return (flags & toCheck) != 0;
		}

        public static bool Has(this SpellAttributes attrs, SpellAttributes toCheck)
        {
            return (attrs & toCheck) != SpellAttributes.None;
        }

        public static bool Has(this SpellAttributesEx attrs, SpellAttributesEx toCheck)
        {
            return (attrs & toCheck) != SpellAttributesEx.None;
        }

		public static bool Has(this SpellAttributesExB flags, SpellAttributesExB toCheck)
		{
			return (flags & toCheck) != SpellAttributesExB.None;
		}

		public static bool Has(this SpellAttributesExC flags, SpellAttributesExC toCheck)
		{
			return (flags & toCheck) != SpellAttributesExC.None;
		}

		public static bool Has(this SpellAttributesExD flags, SpellAttributesExD toCheck)
		{
			return (flags & toCheck) != SpellAttributesExD.None;
		}

        public static bool Has(this SpellAttributesExE flags, SpellAttributesExE toCheck)
        {
            return (flags & toCheck) != SpellAttributesExE.None;
        }

        public static bool Has(this SpellAttributesExF flags, SpellAttributesExF toCheck)
        {
            return (flags & toCheck) != SpellAttributesExF.None;
        }


        public static bool Has(this InterruptFlags flags, InterruptFlags toCheck)
        {
            return (flags & toCheck) != 0;
        }

        public static bool Has(this AuraInterruptFlags flags, AuraInterruptFlags toCheck)
        {
            return (flags & toCheck) != 0;
        }
    }
