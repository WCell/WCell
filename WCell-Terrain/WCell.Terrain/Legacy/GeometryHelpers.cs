...
namespace WCell.Terrain.Legacy
{
    internal static class GeometryHelpers
    {
        ...
        /// <summary>
        /// Returns true if the given point is on the right hand side of --or on-- line segment (origin, destination)
        /// </summary>
        public static bool IsRightOfOrOn(Vector2 point, Vector2 origin, Vector2 destination)
        {
            return IsCounterClockwiseOrColinear(point, destination, origin);
        }
        ...
        /// <summary>
        /// Returns true if the given point is on the left hand side of --or on-- line segment (origin, destination)
        /// </summary>
        public static bool IsLeftOfOrOn(Vector2 point, Vector2 origin, Vector2 destination)
        {
            return IsCounterClockwiseOrColinear(point, origin, destination);
        }
