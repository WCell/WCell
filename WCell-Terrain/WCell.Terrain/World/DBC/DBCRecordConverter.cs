...
namespace TerrainDisplay.World.DBC
{
    ...
    public abstract class DBCRecordConverter : IDisposable
    {
        ...
        {
			return GetString(data, WCellTerrainSettings.DefaultLocale, stringOffset);
        }
        ...
        public string GetString(byte[] data, ClientLocale locale, int stringOffset)
        {
			...
			return WCellTerrainSettings.DefaultEncoding.GetString(m_stringTable, startOffset, len - 1) ?? "";
        }
