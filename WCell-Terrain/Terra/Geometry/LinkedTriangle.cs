...
{
    internal class LinkedTriangle : ILabelled
    {
        public LinkedTriangle(Edge edge) : this(edge, 0)
        {
        }

        public LinkedTriangle(Edge edge, int t)
        {
            Token = t;
            Reshape(edge);
        }
        ...
        public LinkedTriangle NextFace { get; private set; }
        ...
        public LinkedTriangle LinkTo(LinkedTriangle triangle)
        {
            NextFace = triangle;
            return this;
        }
