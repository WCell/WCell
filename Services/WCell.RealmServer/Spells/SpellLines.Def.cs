	...
	public static partial class SpellLines 
	{
		private static void SetupSpellLines()
		{
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.WarriorFuryImprovedSlam, 
				...
				new SpellLine(SpellLineId.WarriorDevastate, 
				...
				new SpellLine(SpellLineId.WarriorDefensiveStance, 
					SpellHandler.Get(SpellId.EffectClassSkillDefensiveStance)),
				new SpellLine(SpellLineId.WarriorTaunt, 
					SpellHandler.Get(SpellId.ClassSkillTaunt)),
				...
				new SpellLine(SpellLineId.WarriorImprovedChallengingShout, 
					SpellHandler.Get(SpellId.ClassSkillImprovedChallengingShoutRank1),
					SpellHandler.Get(SpellId.ClassSkillImprovedChallengingShoutRank2)),
				new SpellLine(SpellLineId.WarriorSweepingStrikes, 
					SpellHandler.Get(SpellId.ClassSkillSweepingStrikesRank1_2),
					SpellHandler.Get(SpellId.ClassSkillSweepingStrikesRank1)),
				new SpellLine(SpellLineId.WarriorFlurry, 
					SpellHandler.Get(SpellId.EffectClassSkillFlurryRank1),
					SpellHandler.Get(SpellId.EffectClassSkillFlurryRank2),
					SpellHandler.Get(SpellId.EffectClassSkillFlurryRank3),
					SpellHandler.Get(SpellId.EffectClassSkillFlurryRank4),
					SpellHandler.Get(SpellId.EffectClassSkillFlurryRank5)),
				new SpellLine(SpellLineId.WarriorImprovedIntimidatingShout, 
					SpellHandler.Get(SpellId.ClassSkillImprovedIntimidatingShoutRank1),
					SpellHandler.Get(SpellId.ClassSkillImprovedIntimidatingShoutRank2)),
				...
				new SpellLine(SpellLineId.WarriorBloodthirst, 
					...
					SpellHandler.Get(SpellId.EffectClassSkillBloodthirst)),
				new SpellLine(SpellLineId.WarriorSecondWind, 
					SpellHandler.Get(SpellId.ClassSkillSecondWindRank1),
					SpellHandler.Get(SpellId.ClassSkillSecondWindRank2)),
				new SpellLine(SpellLineId.WarriorDefianceExpertisePassiveDND, 
					SpellHandler.Get(SpellId.ClassSkillDefianceExpertisePassiveDND)),
				new SpellLine(SpellLineId.WarriorTrauma, 
					SpellHandler.Get(SpellId.EffectClassSkillTraumaRank1),
					SpellHandler.Get(SpellId.EffectClassSkillTraumaRank2)),
				new SpellLine(SpellLineId.WarriorSafeguard, 
					SpellHandler.Get(SpellId.EffectClassSkillSafeguardRank1),
					SpellHandler.Get(SpellId.EffectClassSkillSafeguardRank2)),
				new SpellLine(SpellLineId.WarriorFuriousAttacks, 
					SpellHandler.Get(SpellId.EffectClassSkillFuriousAttacks))};
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.PaladinJudgementOfLight, 
					...
					SpellHandler.Get(SpellId.ClassSkillJudgementOfLightRank1)),
				...
				new SpellLine(SpellLineId.PaladinHolyShock, 
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank1),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank1_2),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank2_2),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank2_3),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank2),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank3),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank3_3),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank3_2),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank4_3),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank4_2),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank4),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank5_3),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank5_2),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank5),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank6_2),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank6_3),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank6),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank7_3),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank7),
					SpellHandler.Get(SpellId.ClassSkillHolyShockRank7_2)),
				...
				new SpellLine(SpellLineId.PaladinHolyShield, 
				...
				new SpellLine(SpellLineId.PaladinJudgementOfWisdom, 
					...
					SpellHandler.Get(SpellId.ClassSkillJudgementOfWisdomRank1)),
				...
				new SpellLine(SpellLineId.PaladinRedemption, 
					SpellHandler.Get(SpellId.ClassSkillRedemptionRank1),
				...
				new SpellLine(SpellLineId.PaladinJudgementOfJustice, 
					...
					SpellHandler.Get(SpellId.ClassSkillJudgementOfJustice)),
				...
				new SpellLine(SpellLineId.PaladinCharger, 
				...
				new SpellLine(SpellLineId.PaladinWarhorse, 
					SpellHandler.Get(SpellId.ClassSkillWarhorseSummon)),
				new SpellLine(SpellLineId.PaladinVindication, 
					SpellHandler.Get(SpellId.EffectClassSkillVindicationRank1),
					SpellHandler.Get(SpellId.EffectClassSkillVindicationRank2)),
				new SpellLine(SpellLineId.PaladinVengeance, 
					SpellHandler.Get(SpellId.EffectClassSkillVengeance_3),
					SpellHandler.Get(SpellId.EffectClassSkillVengeance_2),
					SpellHandler.Get(SpellId.EffectClassSkillVengeance)),
				new SpellLine(SpellLineId.PaladinJudgementOfRighteousness, 
					SpellHandler.Get(SpellId.ClassSkillJudgementOfRighteousnessRank1)),
				new SpellLine(SpellLineId.PaladinImprovedFlashOfLight, 
					SpellHandler.Get(SpellId.ClassSkillImprovedFlashOfLightRank1),
					SpellHandler.Get(SpellId.ClassSkillImprovedFlashOfLightRank2),
					SpellHandler.Get(SpellId.ClassSkillImprovedFlashOfLightRank3)),
				new SpellLine(SpellLineId.PaladinJudgementOfCommand, 
					SpellHandler.Get(SpellId.ClassSkillJudgementOfCommandRank1_2),
					SpellHandler.Get(SpellId.ClassSkillJudgementOfCommandRank1)),
				new SpellLine(SpellLineId.PaladinEyeForAnEye, 
					SpellHandler.Get(SpellId.ClassSkillEyeForAnEyeRank1)),
				new SpellLine(SpellLineId.PaladinHolyVengeance, 
					SpellHandler.Get(SpellId.ClassSkillHolyVengeanceRank1)),
				new SpellLine(SpellLineId.PaladinJudgementOfVengeance, 
					SpellHandler.Get(SpellId.ClassSkillJudgementOfVengeanceRank1)),
				new SpellLine(SpellLineId.PaladinLightsGrace, 
					SpellHandler.Get(SpellId.EffectClassSkillLightsGrace)),
				new SpellLine(SpellLineId.PaladinJudgementOfBlood, 
					SpellHandler.Get(SpellId.ClassSkillJudgementOfBloodRank1)),
				new SpellLine(SpellLineId.PaladinSummonWarhorse, 
					SpellHandler.Get(SpellId.ClassSkillSummonWarhorseSummon)),
				new SpellLine(SpellLineId.PaladinBloodyVengeance, 
					SpellHandler.Get(SpellId.EffectClassSkillBloodyVengeance_3),
					SpellHandler.Get(SpellId.EffectClassSkillBloodyVengeance_2),
					SpellHandler.Get(SpellId.EffectClassSkillBloodyVengeance)),
				new SpellLine(SpellLineId.PaladinTheArtOfWar, 
					SpellHandler.Get(SpellId.EffectClassSkillTheArtOfWar),
					SpellHandler.Get(SpellId.EffectClassSkillTheArtOfWarRank2)),
				new SpellLine(SpellLineId.PaladinLightsBeacon, 
					SpellHandler.Get(SpellId.EffectClassSkillLightsBeacon)),
				new SpellLine(SpellLineId.PaladinBeaconOfLight, 
					SpellHandler.Get(SpellId.ClassSkillBeaconOfLight_3),
					SpellHandler.Get(SpellId.ClassSkillBeaconOfLight_2),
					SpellHandler.Get(SpellId.ClassSkillBeaconOfLight)),
				new SpellLine(SpellLineId.PaladinJudgementsOfThePure, 
					SpellHandler.Get(SpellId.EffectClassSkillJudgementsOfThePureRank1),
					SpellHandler.Get(SpellId.EffectClassSkillJudgementsOfThePureRank2),
					SpellHandler.Get(SpellId.EffectClassSkillJudgementsOfThePureRank3),
					SpellHandler.Get(SpellId.EffectClassSkillJudgementsOfThePureRank4),
					SpellHandler.Get(SpellId.EffectClassSkillJudgementsOfThePureRank5)),
				new SpellLine(SpellLineId.PaladinSacredCleansing, 
					SpellHandler.Get(SpellId.EffectClassSkillSacredCleansing)),
				new SpellLine(SpellLineId.PaladinInfusionOfLight, 
					SpellHandler.Get(SpellId.EffectClassSkillInfusionOfLight),
					SpellHandler.Get(SpellId.EffectClassSkillInfusionOfLightRank2)),
				new SpellLine(SpellLineId.PaladinJudgementOfTheMartyr, 
					SpellHandler.Get(SpellId.ClassSkillJudgementOfTheMartyrRank1)),
				new SpellLine(SpellLineId.PaladinJudgementOfCorruption, 
					SpellHandler.Get(SpellId.ClassSkillJudgementOfCorruptionRank1)),
				new SpellLine(SpellLineId.PaladinBloodCorruption, 
					SpellHandler.Get(SpellId.ClassSkillBloodCorruptionRank1)),
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.HunterPetGenericHunterIntimidation, 
				...
				new SpellLine(SpellLineId.HunterWyvernSting, 
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank1),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank2_2),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank2),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank3_2),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank3),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank4_2),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank4),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank5_2),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank5),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank6_2),
					SpellHandler.Get(SpellId.ClassSkillWyvernStingRank6)),
				new SpellLine(SpellLineId.HunterCounterattack, 
				...
				new SpellLine(SpellLineId.HunterBlackArrow, 
				...
				new SpellLine(SpellLineId.HunterCallPet, 
					SpellHandler.Get(SpellId.ClassSkillCallPet)),
				...
				new SpellLine(SpellLineId.HunterCower, 
					SpellHandler.Get(SpellId.ClassSkillCower)),
				new SpellLine(SpellLineId.HunterDismissPet, 
					SpellHandler.Get(SpellId.ClassSkillDismissPet)),
				new SpellLine(SpellLineId.HunterGrowl, 
					SpellHandler.Get(SpellId.ClassSkillGrowlRank1),
					SpellHandler.Get(SpellId.ClassSkillGrowlRank2),
					SpellHandler.Get(SpellId.ClassSkillGrowlRank3),
					SpellHandler.Get(SpellId.ClassSkillGrowlRank4),
					SpellHandler.Get(SpellId.ClassSkillGrowlRank5),
					SpellHandler.Get(SpellId.ClassSkillGrowlRank6),
					SpellHandler.Get(SpellId.ClassSkillGrowlRank7),
					SpellHandler.Get(SpellId.ClassSkillGrowlRank8),
					SpellHandler.Get(SpellId.ClassSkillGrowlRank9)),
				new SpellLine(SpellLineId.HunterFeedPet, 
					SpellHandler.Get(SpellId.ClassSkillFeedPet)),
				new SpellLine(SpellLineId.HunterTamedPetPassive01DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive01DND)),
				new SpellLine(SpellLineId.HunterExplosiveTrapEffect, 
					SpellHandler.Get(SpellId.ClassSkillExplosiveTrapEffectRank1),
					SpellHandler.Get(SpellId.ClassSkillExplosiveTrapEffectRank2),
					SpellHandler.Get(SpellId.ClassSkillExplosiveTrapEffectRank3),
					SpellHandler.Get(SpellId.ClassSkillExplosiveTrapEffectRank4),
					SpellHandler.Get(SpellId.ClassSkillExplosiveTrapEffectRank5),
					SpellHandler.Get(SpellId.ClassSkillExplosiveTrapEffectRank6)),
				new SpellLine(SpellLineId.HunterTamedPetPassive02DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive02DND)),
				new SpellLine(SpellLineId.HunterTamedPetPassive03DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive03DND)),
				new SpellLine(SpellLineId.HunterTamedPetPassive04DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive04DND)),
				new SpellLine(SpellLineId.HunterTamedPetPassive05DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive05DND)),
				new SpellLine(SpellLineId.HunterTamedPetPassive06DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive06DND)),
				new SpellLine(SpellLineId.HunterTamedPetPassive00DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive00DND)),
				new SpellLine(SpellLineId.HunterTamedPetPassive07DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive07DND)),
				new SpellLine(SpellLineId.HunterImprovedMendPet, 
					SpellHandler.Get(SpellId.ClassSkillImprovedMendPetRank1)),
				new SpellLine(SpellLineId.HunterTheBeastWithin, 
					SpellHandler.Get(SpellId.ClassSkillTheBeastWithin)),
				new SpellLine(SpellLineId.HunterExposeWeakness, 
					SpellHandler.Get(SpellId.EffectClassSkillExposeWeakness)),
				new SpellLine(SpellLineId.HunterTamedPetPassive08DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive08DND)),
				new SpellLine(SpellLineId.HunterTamedPetPassive09DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive09DND)),
				new SpellLine(SpellLineId.HunterTamedPetPassive10DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive10DND)),
				new SpellLine(SpellLineId.HunterMasterTactician, 
					SpellHandler.Get(SpellId.EffectClassSkillMasterTacticianRank1),
					SpellHandler.Get(SpellId.EffectClassSkillMasterTacticianRank2),
					SpellHandler.Get(SpellId.EffectClassSkillMasterTacticianRank3),
					SpellHandler.Get(SpellId.EffectClassSkillMasterTacticianRank4),
					SpellHandler.Get(SpellId.EffectClassSkillMasterTacticianRank5)),
				new SpellLine(SpellLineId.HunterRapidKilling, 
					SpellHandler.Get(SpellId.EffectClassSkillRapidKillingRank1),
					SpellHandler.Get(SpellId.EffectClassSkillRapidKillingRank2)),
				new SpellLine(SpellLineId.HunterConcussiveBarrage, 
					SpellHandler.Get(SpellId.EffectClassSkillConcussiveBarrage)),
				new SpellLine(SpellLineId.HunterImprovedSteadyShot, 
					SpellHandler.Get(SpellId.EffectClassSkillImprovedSteadyShot)),
				new SpellLine(SpellLineId.HunterRapidRecuperationEffect, 
					SpellHandler.Get(SpellId.EffectClassSkillRapidRecuperationEffect)),
				new SpellLine(SpellLineId.HunterWildQuiverAutoShot, 
					SpellHandler.Get(SpellId.EffectClassSkillWildQuiverAutoShot)),
				new SpellLine(SpellLineId.HunterInvigoration, 
					SpellHandler.Get(SpellId.ClassSkillInvigorationRank1)),
				new SpellLine(SpellLineId.HunterTamedPetPassive11DND, 
					SpellHandler.Get(SpellId.ClassSkillTamedPetPassive11DND)),
				new SpellLine(SpellLineId.HunterLockAndLoad, 
					SpellHandler.Get(SpellId.EffectClassSkillLockAndLoad)),
				new SpellLine(SpellLineId.HunterFreezingArrowEffect, 
					SpellHandler.Get(SpellId.ClassSkillFreezingArrowEffectRank1)),
				new SpellLine(SpellLineId.HunterCallStabledPet, 
					SpellHandler.Get(SpellId.ClassSkillCallStabledPet)),
				new SpellLine(SpellLineId.HunterFerociousInspiration, 
					SpellHandler.Get(SpellId.ClassSkillFerociousInspiration_3),
					SpellHandler.Get(SpellId.ClassSkillFerociousInspiration_2),
					SpellHandler.Get(SpellId.ClassSkillFerociousInspiration))};
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.RogueCombatPuncturingWounds, 
				...
				new SpellLine(SpellLineId.RogueRoguePassiveDND, 
				...
				new SpellLine(SpellLineId.RogueHemorrhage, 
				...
				new SpellLine(SpellLineId.RogueRelentlessStrikesEffect, 
					SpellHandler.Get(SpellId.EffectClassSkillRelentlessStrikesEffectRank1)),
				new SpellLine(SpellLineId.RogueSilencedGagOrder, 
					SpellHandler.Get(SpellId.EffectClassSkillSilencedGagOrder)),
				new SpellLine(SpellLineId.RogueIntuition, 
					SpellHandler.Get(SpellId.ClassSkillIntuition_4),
					SpellHandler.Get(SpellId.ClassSkillIntuition_5),
					SpellHandler.Get(SpellId.ClassSkillIntuition_3),
					SpellHandler.Get(SpellId.ClassSkillIntuition),
					SpellHandler.Get(SpellId.ClassSkillIntuition_2)),
				new SpellLine(SpellLineId.RogueBladeTwisting, 
					SpellHandler.Get(SpellId.EffectClassSkillBladeTwisting)),
				new SpellLine(SpellLineId.RogueFocusedAttacks, 
					SpellHandler.Get(SpellId.EffectClassSkillFocusedAttacks)),
				new SpellLine(SpellLineId.RogueUnfairAdvantage, 
					SpellHandler.Get(SpellId.EffectClassSkillUnfairAdvantageRank1),
					SpellHandler.Get(SpellId.EffectClassSkillUnfairAdvantageRank2)),
				new SpellLine(SpellLineId.RogueThrowingSpecialization, 
					SpellHandler.Get(SpellId.EffectClassSkillThrowingSpecialization)),
				new SpellLine(SpellLineId.RogueWaylay, 
					SpellHandler.Get(SpellId.EffectClassSkillWaylay)),
				new SpellLine(SpellLineId.RogueHonorAmongThieves, 
					SpellHandler.Get(SpellId.ClassSkillHonorAmongThieves)),
				new SpellLine(SpellLineId.RogueOverkill, 
					SpellHandler.Get(SpellId.ClassSkillOverkill))};
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.PriestShadowMagicShadowWeaving, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicShadowFocus, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicSpiritTap, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicShadowAffinity, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicImprovedSpiritTap, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicMindFlay, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicShadowReach, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicImprovedVampiricEmbrace, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicMisery, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicFocusedMind, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicShadowPower, 
				...
				new SpellLine(SpellLineId.PriestShadowMagicImprovedShadowform, 
				...
				new SpellLine(SpellLineId.PriestDisciplineImprovedFlashHeal, 
					SpellHandler.Get(SpellId.PriestDisciplineImprovedFlashHealRank1_3),
					SpellHandler.Get(SpellId.PriestDisciplineImprovedFlashHealRank1_2),
				...
				new SpellLine(SpellLineId.PriestHolyNova, 
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank1_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank1),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank2_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank3_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank3),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank4),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank4_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank5),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank5_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank6_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank6),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank7_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank7),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank8_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank8),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank9_2),
					SpellHandler.Get(SpellId.ClassSkillHolyNovaRank9)),
				...
				new SpellLine(SpellLineId.PriestVampiricTouch, 
					SpellHandler.Get(SpellId.ClassSkillVampiricTouch),
				...
				new SpellLine(SpellLineId.PriestLightwell, 
				...
				new SpellLine(SpellLineId.PriestCircleOfHealing, 
				...
				new SpellLine(SpellLineId.PriestPenance, 
					SpellHandler.Get(SpellId.ClassSkillPenanceRank1_2),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank1),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank2_2),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank2_3),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank2),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank3_3),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank3_2),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank3),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank4_3),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank4),
					SpellHandler.Get(SpellId.ClassSkillPenanceRank4_2)),
				...
				new SpellLine(SpellLineId.PriestDesperatePrayer, 
				...
				new SpellLine(SpellLineId.PriestLightwellRenew, 
					SpellHandler.Get(SpellId.ClassSkillLightwellRenewRank1),
					SpellHandler.Get(SpellId.ClassSkillLightwellRenewRank2),
					SpellHandler.Get(SpellId.ClassSkillLightwellRenewRank3),
					SpellHandler.Get(SpellId.ClassSkillLightwellRenewRank4),
					SpellHandler.Get(SpellId.ClassSkillLightwellRenewRank5),
					SpellHandler.Get(SpellId.ClassSkillLightwellRenewRank6)),
				new SpellLine(SpellLineId.PriestFocusedCasting, 
					SpellHandler.Get(SpellId.EffectClassSkillFocusedCastingRank1),
					SpellHandler.Get(SpellId.EffectClassSkillFocusedCastingRank2)),
				new SpellLine(SpellLineId.PriestBlessedRecovery, 
					SpellHandler.Get(SpellId.ClassSkillBlessedRecoveryRank1),
					SpellHandler.Get(SpellId.ClassSkillBlessedRecoveryRank2),
					SpellHandler.Get(SpellId.ClassSkillBlessedRecoveryRank3)),
				new SpellLine(SpellLineId.PriestMassResurrection, 
					SpellHandler.Get(SpellId.ClassSkillMassResurrection)),
				new SpellLine(SpellLineId.PriestBlessedResilience, 
					SpellHandler.Get(SpellId.EffectClassSkillBlessedResilienceRank1)),
				new SpellLine(SpellLineId.PriestSurgeOfLight, 
					SpellHandler.Get(SpellId.EffectClassSkillSurgeOfLightRank1)),
				new SpellLine(SpellLineId.PriestMisery, 
					SpellHandler.Get(SpellId.EffectClassSkillMiseryRank1),
					SpellHandler.Get(SpellId.EffectClassSkillMiseryRank2),
					SpellHandler.Get(SpellId.EffectClassSkillMiseryRank3)),
				new SpellLine(SpellLineId.PriestReflectiveShield, 
					SpellHandler.Get(SpellId.ClassSkillReflectiveShield)),
				new SpellLine(SpellLineId.PriestHolyConcentration, 
					SpellHandler.Get(SpellId.EffectClassSkillHolyConcentration)),
				new SpellLine(SpellLineId.PriestPainSuppression, 
					SpellHandler.Get(SpellId.ClassSkillPainSuppression)),
				new SpellLine(SpellLineId.PriestFocusedWill, 
					SpellHandler.Get(SpellId.EffectClassSkillFocusedWillRank1),
					SpellHandler.Get(SpellId.EffectClassSkillFocusedWillRank2),
					SpellHandler.Get(SpellId.EffectClassSkillFocusedWillRank3)),
				new SpellLine(SpellLineId.PriestGuardianSpirit, 
					SpellHandler.Get(SpellId.ClassSkillGuardianSpirit)),
				new SpellLine(SpellLineId.PriestShadowform, 
					SpellHandler.Get(SpellId.ClassSkillShadowform)),
				new SpellLine(SpellLineId.PriestGlyphOfDispelMagic, 
					SpellHandler.Get(SpellId.EffectClassSkillGlyphOfDispelMagic)),
				...
				new SpellLine(SpellLineId.PriestSerendipity, 
					SpellHandler.Get(SpellId.EffectClassSkillSerendipity_3),
					SpellHandler.Get(SpellId.EffectClassSkillSerendipity_2),
					SpellHandler.Get(SpellId.EffectClassSkillSerendipity)),
				new SpellLine(SpellLineId.PriestPsychicHorror, 
					SpellHandler.Get(SpellId.EffectClassSkillPsychicHorror))};

			AddSpellLines(ClassId.Priest, lines);
			#endregion

			#region DeathKnight (142)
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.DeathKnightBloodImprovedDeathStrike, 
					SpellHandler.Get(SpellId.DeathKnightBloodImprovedDeathStrikeRank1_2),
				...
				new SpellLine(SpellLineId.DeathKnightUnholyDesolation, 
					SpellHandler.Get(SpellId.DeathKnightUnholyDesolationRank1_4),
					SpellHandler.Get(SpellId.DeathKnightUnholyDesolationRank1_5),
					SpellHandler.Get(SpellId.DeathKnightUnholyDesolationRank1_3),
					SpellHandler.Get(SpellId.DeathKnightUnholyDesolationRank1),
					SpellHandler.Get(SpellId.DeathKnightUnholyDesolationRank1_2)),
				new SpellLine(SpellLineId.DeathKnightPlagueStrike, 
					SpellHandler.Get(SpellId.ClassSkillPlagueStrikeRank1_3),
					SpellHandler.Get(SpellId.ClassSkillPlagueStrikeRank1_2),
				...
				new SpellLine(SpellLineId.DeathKnightIcyTouch, 
					SpellHandler.Get(SpellId.ClassSkillIcyTouchRank1_2),
				...
				new SpellLine(SpellLineId.DeathKnightBloodStrike, 
					SpellHandler.Get(SpellId.ClassSkillBloodStrikeRank1_3),
					SpellHandler.Get(SpellId.ClassSkillBloodStrikeRank1_2),
				...
				new SpellLine(SpellLineId.DeathKnightDeathCoil, 
					...
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank1_3),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank1_4),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank1_2),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank2_2),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank2_3),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank3_2),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank3_3),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank4_3),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank4_2),
					SpellHandler.Get(SpellId.ClassSkillDeathCoilRank5_3),
				...
				new SpellLine(SpellLineId.DeathKnightDeathGrip, 
					...
					SpellHandler.Get(SpellId.ClassSkillDeathGrip)),
				...
				new SpellLine(SpellLineId.DeathKnightDeathStrike, 
					...
					SpellHandler.Get(SpellId.ClassSkillDeathStrike_2),
					SpellHandler.Get(SpellId.ClassSkillDeathStrikeRank1),
					SpellHandler.Get(SpellId.ClassSkillDeathStrikeRank1_2),
				...
				new SpellLine(SpellLineId.DeathKnightObliterate, 
					SpellHandler.Get(SpellId.ClassSkillObliterateRank1_2),
				...
				new SpellLine(SpellLineId.DeathKnightCorpseExplosion, 
					SpellHandler.Get(SpellId.ClassSkillCorpseExplosion),
				...
				new SpellLine(SpellLineId.DeathKnightHowlingBlast, 
				...
				new SpellLine(SpellLineId.DeathKnightFrostStrike, 
					SpellHandler.Get(SpellId.ClassSkillFrostStrikeRank1),
				...
				new SpellLine(SpellLineId.DeathKnightRuneStrike, 
					...
					SpellHandler.Get(SpellId.ClassSkillRuneStrikeRank1)),
				...
				new SpellLine(SpellLineId.DeathKnightFrozenRuneWeapon, 
					SpellHandler.Get(SpellId.ClassSkillFrozenRuneWeapon)),
				new SpellLine(SpellLineId.DeathKnightUnholyOnAPaleHorse, 
					SpellHandler.Get(SpellId.LearnDeathKnightUnholyOnAPaleHorseRank1),
					SpellHandler.Get(SpellId.LearnDeathKnightUnholyOnAPaleHorseRank2)),
				new SpellLine(SpellLineId.DeathKnightBloodWillOfTheNecropolis, 
					SpellHandler.Get(SpellId.LearnDeathKnightBloodWillOfTheNecropolisRank1),
					SpellHandler.Get(SpellId.LearnDeathKnightBloodWillOfTheNecropolisRank2),
					SpellHandler.Get(SpellId.LearnDeathKnightBloodWillOfTheNecropolisRank3)),
				new SpellLine(SpellLineId.DeathKnightBloodGorged, 
					SpellHandler.Get(SpellId.ClassSkillBloodGorgedRank1),
					SpellHandler.Get(SpellId.DeathKnightBloodBloodGorgedRank1),
					SpellHandler.Get(SpellId.ClassSkillBloodGorgedRank2),
					SpellHandler.Get(SpellId.DeathKnightBloodBloodGorgedRank2),
					SpellHandler.Get(SpellId.DeathKnightBloodBloodGorgedRank3),
					SpellHandler.Get(SpellId.ClassSkillBloodGorgedRank3),
					SpellHandler.Get(SpellId.DeathKnightBloodBloodGorgedRank4),
					SpellHandler.Get(SpellId.ClassSkillBloodGorgedRank4),
					SpellHandler.Get(SpellId.ClassSkillBloodGorgedRank5),
					SpellHandler.Get(SpellId.DeathKnightBloodBloodGorgedRank5)),
				new SpellLine(SpellLineId.DeathKnightUnholyBlight, 
					SpellHandler.Get(SpellId.ClassSkillUnholyBlight)),
				new SpellLine(SpellLineId.DeathKnightOnAPaleHorse, 
					SpellHandler.Get(SpellId.DeathKnightUnholyOnAPaleHorseRank1),
					SpellHandler.Get(SpellId.ClassSkillOnAPaleHorseRank1),
					SpellHandler.Get(SpellId.DeathKnightUnholyOnAPaleHorseRank2),
					SpellHandler.Get(SpellId.ClassSkillOnAPaleHorseRank2)),
				new SpellLine(SpellLineId.DeathKnightWillOfTheNecropolis, 
				...
				new SpellLine(SpellLineId.DeathKnightBloodBloodGorged, 
					SpellHandler.Get(SpellId.LearnDeathKnightBloodBloodGorgedRank1),
					SpellHandler.Get(SpellId.LearnDeathKnightBloodBloodGorgedRank2),
					SpellHandler.Get(SpellId.LearnDeathKnightBloodBloodGorgedRank3),
					SpellHandler.Get(SpellId.LearnDeathKnightBloodBloodGorgedRank4),
					SpellHandler.Get(SpellId.LearnDeathKnightBloodBloodGorgedRank5)),
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.ShamanElementalCombatCallOfThunder, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatElementalFury, 
					SpellHandler.Get(SpellId.ShamanElementalElementalFury_4),
					SpellHandler.Get(SpellId.ShamanElementalElementalFury_5),
					SpellHandler.Get(SpellId.ShamanElementalElementalFury_3),
					SpellHandler.Get(SpellId.ShamanElementalElementalFury),
					SpellHandler.Get(SpellId.ShamanElementalElementalFury_2)),
				...
				new SpellLine(SpellLineId.ShamanElementalCombatLightningMastery, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatEyeOfTheStorm, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatElementalDevastation, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatUnrelentingStorm, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatLightningOverload, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatTotemOfWrath, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatAstralShift, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatStormEarthAndFire, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatThunderstorm, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatShamanism, 
				...
				new SpellLine(SpellLineId.ShamanElementalCombatBoomingEchoes, 
					SpellHandler.Get(SpellId.ShamanElementalBoomingEchoesRank1),
					SpellHandler.Get(SpellId.ShamanElementalBoomingEchoesRank2)),
				new SpellLine(SpellLineId.ShamanElementalCombatFrozenPower, 
				...
				new SpellLine(SpellLineId.ShamanLightningBolt, 
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank1_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank1),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank2_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank3),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank3_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank4_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank4),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank5_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank5),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank6),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank6_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank7),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank7_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank8),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank8_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank9_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank9),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank10_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank10),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank11_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank11),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank12_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank12),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank13_2),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank13),
					SpellHandler.Get(SpellId.ClassSkillLightningBoltRank14_2),
				...
				new SpellLine(SpellLineId.ShamanSearingTotem, 
					SpellHandler.Get(SpellId.ClassSkillSearingTotemRank1),
				...
				new SpellLine(SpellLineId.ShamanRiptide, 
				...
				new SpellLine(SpellLineId.ShamanStoneskinTotem, 
					SpellHandler.Get(SpellId.ClassSkillStoneskinTotemRank1),
				...
				new SpellLine(SpellLineId.ShamanChainLightning, 
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank1_2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank1),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank2_2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank3),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank3_2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank4_2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank4),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank5_2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank5),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank6_2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank6),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank7_2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank7),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank8_2),
					SpellHandler.Get(SpellId.ClassSkillChainLightningRank8)),
				...
				new SpellLine(SpellLineId.ShamanFireNova, 
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank1_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank1),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank2_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank3_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank3),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank4_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank4),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank5_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank5),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank6_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank6),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank7_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank7),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank8_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank8),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank9_2),
					SpellHandler.Get(SpellId.ClassSkillFireNovaRank9)),
				new SpellLine(SpellLineId.ShamanTotemOfWrath, 
					SpellHandler.Get(SpellId.ClassSkillTotemOfWrath),
				...
				new SpellLine(SpellLineId.ShamanReincarnation, 
					SpellHandler.Get(SpellId.ClassSkillReincarnation),
					SpellHandler.Get(SpellId.ClassSkillReincarnationPassive)),
				new SpellLine(SpellLineId.ShamanHealingStreamTotem, 
					SpellHandler.Get(SpellId.ClassSkillHealingStreamTotemRank1),
				...
				new SpellLine(SpellLineId.ShamanLightningShield, 
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank1_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank1),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank2_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank3),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank3_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank4),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank4_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank5),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank5_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank6),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank6_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank7_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank7),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank8_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank8),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank9_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank9),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank10_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank10),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank11_2),
					SpellHandler.Get(SpellId.ClassSkillLightningShieldRank11)),
				...
				new SpellLine(SpellLineId.ShamanAncestralFortitude, 
					SpellHandler.Get(SpellId.EffectClassSkillAncestralFortitudeRank1),
					SpellHandler.Get(SpellId.EffectClassSkillAncestralFortitudeRank2),
					SpellHandler.Get(SpellId.EffectClassSkillAncestralFortitudeRank3)),
				new SpellLine(SpellLineId.ShamanEnhancementSpiritWeapons, 
					SpellHandler.Get(SpellId.LearnShamanEnhancementSpiritWeapons)),
				new SpellLine(SpellLineId.ShamanElementalDevastation, 
					SpellHandler.Get(SpellId.EffectClassSkillElementalDevastationRank1),
					SpellHandler.Get(SpellId.EffectClassSkillElementalDevastationRank2),
					SpellHandler.Get(SpellId.EffectClassSkillElementalDevastationRank3)),
				new SpellLine(SpellLineId.ShamanElementalShields, 
					SpellHandler.Get(SpellId.ClassSkillElementalShieldsRank1),
					SpellHandler.Get(SpellId.ClassSkillElementalShieldsRank2),
					SpellHandler.Get(SpellId.ClassSkillElementalShieldsRank3)),
				new SpellLine(SpellLineId.ShamanEnhancementDualWield, 
					SpellHandler.Get(SpellId.LearnShamanEnhancementDualWield)),
				new SpellLine(SpellLineId.ShamanShamanisticRage, 
					SpellHandler.Get(SpellId.EffectClassSkillShamanisticRage)),
				new SpellLine(SpellLineId.ShamanGiftOfTheWaterSpirit, 
					SpellHandler.Get(SpellId.ClassSkillGiftOfTheWaterSpirit)),
				new SpellLine(SpellLineId.ShamanStormstrike, 
					SpellHandler.Get(SpellId.EffectClassSkillStormstrike_2),
					SpellHandler.Get(SpellId.EffectClassSkillStormstrike)),
				new SpellLine(SpellLineId.ShamanSpiritWeapons, 
					SpellHandler.Get(SpellId.ClassSkillSpiritWeaponsPassive)),
				new SpellLine(SpellLineId.ShamanFocused, 
					SpellHandler.Get(SpellId.ClassSkillFocused)),
				new SpellLine(SpellLineId.ShamanTidalForce, 
					SpellHandler.Get(SpellId.ClassSkillTidalForce)),
				new SpellLine(SpellLineId.ShamanMaelstromReady, 
					SpellHandler.Get(SpellId.ClassSkillMaelstromReady)),
				new SpellLine(SpellLineId.ShamanFreeze, 
					SpellHandler.Get(SpellId.ClassSkillFreeze)),
				new SpellLine(SpellLineId.ShamanFlameShockPassive, 
					SpellHandler.Get(SpellId.ClassSkillFlameShockPassive))};
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.MagePolymorph, 
					SpellHandler.Get(SpellId.ClassSkillPolymorphSerpent),
					SpellHandler.Get(SpellId.ClassSkillPolymorphPig),
					SpellHandler.Get(SpellId.ClassSkillPolymorphRabbit),
					SpellHandler.Get(SpellId.ClassSkillPolymorphBlackCat),
					SpellHandler.Get(SpellId.ClassSkillPolymorphTurkey),
					SpellHandler.Get(SpellId.ClassSkillPolymorphTurtle),
				...
				new SpellLine(SpellLineId.MageBlastWave, 
				...
				new SpellLine(SpellLineId.MageDragonsBreath, 
				...
				new SpellLine(SpellLineId.MageIceBarrier, 
				...
				new SpellLine(SpellLineId.MageLivingBomb, 
					SpellHandler.Get(SpellId.ClassSkillLivingBombRank1),
					SpellHandler.Get(SpellId.ClassSkillLivingBombRank2_2),
					SpellHandler.Get(SpellId.ClassSkillLivingBombRank2),
					SpellHandler.Get(SpellId.ClassSkillLivingBombRank3_2),
				...
				new SpellLine(SpellLineId.MageArcaneMissile, 
					SpellHandler.Get(SpellId.EffectClassSkillArcaneMissileRank1)),
				new SpellLine(SpellLineId.MageImpact, 
					SpellHandler.Get(SpellId.EffectClassSkillImpactRank1)),
				new SpellLine(SpellLineId.MageChilled, 
					...
					SpellHandler.Get(SpellId.ClassSkillChilledRank3)),
				new SpellLine(SpellLineId.MageFrostbite, 
					SpellHandler.Get(SpellId.EffectClassSkillFrostbite)),
				new SpellLine(SpellLineId.MageClearcasting, 
					SpellHandler.Get(SpellId.EffectClassSkillClearcasting)),
				new SpellLine(SpellLineId.MageIgnite, 
					SpellHandler.Get(SpellId.ClassSkillIgnite)),
				new SpellLine(SpellLineId.MageImprovedScorch, 
					SpellHandler.Get(SpellId.EffectClassSkillImprovedScorch)),
				new SpellLine(SpellLineId.MageFelfire, 
					SpellHandler.Get(SpellId.ClassSkillFelfire)),
				new SpellLine(SpellLineId.MageMasterOfElements, 
					SpellHandler.Get(SpellId.ClassSkillMasterOfElements)),
				new SpellLine(SpellLineId.MageMagicAbsorption, 
					SpellHandler.Get(SpellId.ClassSkillMagicAbsorption)),
				new SpellLine(SpellLineId.MageBlazingSpeed, 
					SpellHandler.Get(SpellId.ClassSkillBlazingSpeed)),
				new SpellLine(SpellLineId.MageMissileBarrage, 
					SpellHandler.Get(SpellId.EffectClassSkillMissileBarrage)),
				new SpellLine(SpellLineId.MageIncantersAbsorption, 
					SpellHandler.Get(SpellId.EffectClassSkillIncantersAbsorption)),
				new SpellLine(SpellLineId.MageFieryPayback, 
					SpellHandler.Get(SpellId.MageFireFieryPaybackRank1),
					SpellHandler.Get(SpellId.ClassSkillFieryPaybackRank2_2),
					SpellHandler.Get(SpellId.ClassSkillFieryPaybackRank2),
					SpellHandler.Get(SpellId.MageFireFieryPaybackRank2)),
				new SpellLine(SpellLineId.MageBurnout, 
					SpellHandler.Get(SpellId.ClassSkillBurnout)),
				new SpellLine(SpellLineId.MageFingersOfFrost, 
					SpellHandler.Get(SpellId.EffectClassSkillFingersOfFrost)),
				new SpellLine(SpellLineId.MageFocusMagic, 
					SpellHandler.Get(SpellId.ClassSkillFocusMagic)),
				new SpellLine(SpellLineId.MageFirestarter, 
					SpellHandler.Get(SpellId.EffectClassSkillFirestarter)),
				new SpellLine(SpellLineId.MageBurningDetermination, 
					SpellHandler.Get(SpellId.EffectClassSkillBurningDetermination)),
				new SpellLine(SpellLineId.MageDalaranIntellect, 
					SpellHandler.Get(SpellId.ClassSkillDalaranIntellectRank7)),
				new SpellLine(SpellLineId.MageDalaranBrilliance, 
					SpellHandler.Get(SpellId.ClassSkillDalaranBrillianceRank3)),
				new SpellLine(SpellLineId.MageFireFieryPayback, 
					SpellHandler.Get(SpellId.LearnMageFireFieryPaybackRank1_2),
					SpellHandler.Get(SpellId.LearnMageFireFieryPaybackRank1)),
				new SpellLine(SpellLineId.MageSummonWaterElementalPrototype, 
					SpellHandler.Get(SpellId.ClassSkillSummonWaterElementalPrototype)),
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.WarlockDemonologyMasterDemonologist, 
					SpellHandler.Get(SpellId.WarlockDemonologyMasterDemonologist_4),
					SpellHandler.Get(SpellId.WarlockDemonologyMasterDemonologist_5),
					SpellHandler.Get(SpellId.WarlockDemonologyMasterDemonologist_3),
					SpellHandler.Get(SpellId.WarlockDemonologyMasterDemonologist),
					SpellHandler.Get(SpellId.WarlockDemonologyMasterDemonologist_2)),
				...
				new SpellLine(SpellLineId.WarlockDemonologySummonFelguard, 
				...
				new SpellLine(SpellLineId.WarlockDemonologyEmpoweredImp, 
				...
				new SpellLine(SpellLineId.WarlockDestructionMoltenSkin, 
					SpellHandler.Get(SpellId.WarlockDestructionMoltenSkinRank1_2),
				...
				new SpellLine(SpellLineId.WarlockShadowburn, 
				...
				new SpellLine(SpellLineId.WarlockDarkPact, 
				...
				new SpellLine(SpellLineId.WarlockHaunt, 
				...
				new SpellLine(SpellLineId.WarlockChaosBolt, 
				...
				new SpellLine(SpellLineId.WarlockShadowfury, 
				...
				new SpellLine(SpellLineId.WarlockCurseOfIdiocy, 
					SpellHandler.Get(SpellId.EffectClassSkillCurseOfIdiocyRank1)),
				new SpellLine(SpellLineId.WarlockInferno, 
					SpellHandler.Get(SpellId.ClassSkillInfernoSummon)),
				new SpellLine(SpellLineId.WarlockFelsteed, 
					SpellHandler.Get(SpellId.ClassSkillFelsteedSummon)),
				new SpellLine(SpellLineId.WarlockHellfireEffect, 
					SpellHandler.Get(SpellId.EffectClassSkillHellfireEffectRank1),
					SpellHandler.Get(SpellId.EffectClassSkillHellfireEffectRank2),
					SpellHandler.Get(SpellId.EffectClassSkillHellfireEffectRank3),
					SpellHandler.Get(SpellId.EffectClassSkillHellfireEffectRank4),
					SpellHandler.Get(SpellId.EffectClassSkillHellfireEffectRank5)),
				new SpellLine(SpellLineId.WarlockRitualOfDoom, 
					SpellHandler.Get(SpellId.ClassSkillRitualOfDoom)),
				new SpellLine(SpellLineId.WarlockRitualOfDoomEffect, 
					SpellHandler.Get(SpellId.ClassSkillRitualOfDoomEffect)),
				new SpellLine(SpellLineId.WarlockCurseOfDoomEffect, 
					SpellHandler.Get(SpellId.ClassSkillCurseOfDoomEffect)),
				new SpellLine(SpellLineId.WarlockImprovedEnslaveDemon, 
					SpellHandler.Get(SpellId.ClassSkillImprovedEnslaveDemonRank2)),
				new SpellLine(SpellLineId.WarlockMasterDemonologist, 
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_17),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_18),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_19),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_14),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_15),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_16),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_23),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_24),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_25),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_20),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_21),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_22),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_13),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_4),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_5),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_6),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_2),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_3),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_10),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_11),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_12),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_7),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_8),
					SpellHandler.Get(SpellId.ClassSkillMasterDemonologist_9)),
				new SpellLine(SpellLineId.WarlockCreateSoulwell, 
					SpellHandler.Get(SpellId.ClassSkillCreateSoulwell_2),
					SpellHandler.Get(SpellId.ClassSkillCreateSoulwell)),
				new SpellLine(SpellLineId.WarlockShadowEmbrace, 
					SpellHandler.Get(SpellId.EffectClassSkillShadowEmbrace_4),
					SpellHandler.Get(SpellId.EffectClassSkillShadowEmbrace_5),
					SpellHandler.Get(SpellId.EffectClassSkillShadowEmbrace_3),
					SpellHandler.Get(SpellId.EffectClassSkillShadowEmbrace),
					SpellHandler.Get(SpellId.EffectClassSkillShadowEmbrace_2)),
				new SpellLine(SpellLineId.WarlockBacklash, 
					SpellHandler.Get(SpellId.EffectClassSkillBacklash)),
				new SpellLine(SpellLineId.WarlockAtrocity, 
					SpellHandler.Get(SpellId.ClassSkillAtrocityRank1)),
				new SpellLine(SpellLineId.WarlockMetamorphosis, 
					SpellHandler.Get(SpellId.LearnClassSkillMetamorphosis),
					SpellHandler.Get(SpellId.ClassSkillMetamorphosis_2),
					SpellHandler.Get(SpellId.WarlockDemonologyMetamorphosis),
					SpellHandler.Get(SpellId.ClassSkillMetamorphosis)),
				new SpellLine(SpellLineId.WarlockKindlingSoul, 
					SpellHandler.Get(SpellId.ClassSkillKindlingSoulRank1),
					SpellHandler.Get(SpellId.ClassSkillKindlingSoulRank2)),
				new SpellLine(SpellLineId.WarlockTorture, 
					SpellHandler.Get(SpellId.ClassSkillTortureRank1),
					SpellHandler.Get(SpellId.ClassSkillTortureRank2),
					SpellHandler.Get(SpellId.ClassSkillTortureRank3)),
				new SpellLine(SpellLineId.WarlockShadowCleave, 
					SpellHandler.Get(SpellId.ClassSkillShadowCleaveDemon)),
				new SpellLine(SpellLineId.WarlockImmolationAura, 
					SpellHandler.Get(SpellId.ClassSkillImmolationAuraDemon)),
				new SpellLine(SpellLineId.WarlockSuddenFear, 
					SpellHandler.Get(SpellId.ClassSkillSuddenFear)),
				new SpellLine(SpellLineId.WarlockChallengingHowl, 
					SpellHandler.Get(SpellId.ClassSkillChallengingHowlDemon)),
			...
			lines = new SpellLine[]
			{
				...
				new SpellLine(SpellLineId.DruidFeralCombatMasterShapeshifter, 
					SpellHandler.Get(SpellId.DruidRestorationMasterShapeshifter_2),
				...
				new SpellLine(SpellLineId.DruidWildGrowth, 
				...
				new SpellLine(SpellLineId.DruidStarfall, 
				...
				new SpellLine(SpellLineId.DruidMaul, 
					SpellHandler.Get(SpellId.ClassSkillMaulRank1),
				...
				new SpellLine(SpellLineId.DruidMangleBear, 
				...
				new SpellLine(SpellLineId.DruidFrenziedRegeneration, 
					SpellHandler.Get(SpellId.ClassSkillFrenziedRegeneration_2),
				...
				new SpellLine(SpellLineId.DruidMangleCat, 
					SpellHandler.Get(SpellId.ClassSkillMangleCatRank1),
				...
				new SpellLine(SpellLineId.DruidDireBearForm, 
				...
				new SpellLine(SpellLineId.DruidTyphoon, 
				...
				new SpellLine(SpellLineId.DruidAbolishPoisonEffect, 
					SpellHandler.Get(SpellId.EffectClassSkillAbolishPoisonEffect)),
				new SpellLine(SpellLineId.DruidTreeOfLife, 
					SpellHandler.Get(SpellId.DruidRestorationTreeOfLifeShapeshift),
					SpellHandler.Get(SpellId.ClassSkillTreeOfLifePassive)),
				...
				new SpellLine(SpellLineId.DruidGrowl, 
					SpellHandler.Get(SpellId.ClassSkillGrowl)),
				new SpellLine(SpellLineId.DruidCurePoison, 
					SpellHandler.Get(SpellId.ClassSkillCurePoison)),
				new SpellLine(SpellLineId.DruidPounceBleed, 
					SpellHandler.Get(SpellId.EffectClassSkillPounceBleedRank1),
					SpellHandler.Get(SpellId.EffectClassSkillPounceBleedRank2),
					SpellHandler.Get(SpellId.EffectClassSkillPounceBleedRank3),
					SpellHandler.Get(SpellId.EffectClassSkillPounceBleedRank4),
					SpellHandler.Get(SpellId.EffectClassSkillPounceBleedRank5)),
				new SpellLine(SpellLineId.DruidDireBearFormPassive, 
					SpellHandler.Get(SpellId.ClassSkillDireBearFormPassivePassive)),
				...
				new SpellLine(SpellLineId.DruidFeralChargeBear, 
				...
				new SpellLine(SpellLineId.DruidMoonkinFormPassive, 
					SpellHandler.Get(SpellId.ClassSkillMoonkinFormPassivePassive)),
				new SpellLine(SpellLineId.DruidMoonkinAura, 
					SpellHandler.Get(SpellId.EffectClassSkillMoonkinAura)),
				new SpellLine(SpellLineId.DruidFeralCombatMangle, 
					SpellHandler.Get(SpellId.LearnDruidFeralCombatMangleRank1)),
				new SpellLine(SpellLineId.DruidImprovedLeaderOfThePack, 
					SpellHandler.Get(SpellId.ClassSkillImprovedLeaderOfThePack)),
				new SpellLine(SpellLineId.DruidFeralCombatPrimalFury, 
					SpellHandler.Get(SpellId.LearnDruidFeralCombatPrimalFuryRank1),
					SpellHandler.Get(SpellId.LearnDruidFeralCombatPrimalFuryRank2)),
				...
				new SpellLine(SpellLineId.DruidFeralChargeCat, 
					SpellHandler.Get(SpellId.ClassSkillFeralChargeCat)),
				new SpellLine(SpellLineId.DruidFeralCombatFeralCharge, 
					SpellHandler.Get(SpellId.LearnDruidFeralCombatFeralChargeRank1)),
				new SpellLine(SpellLineId.DruidSurvivalInstincts, 
					SpellHandler.Get(SpellId.ClassSkillSurvivalInstincts)),
				new SpellLine(SpellLineId.DruidRestorationTreeOfLife, 
					SpellHandler.Get(SpellId.LearnDruidRestorationTreeOfLifeRank1)),
				new SpellLine(SpellLineId.DruidImprovedBarkskinPassive, 
					SpellHandler.Get(SpellId.ClassSkillImprovedBarkskinPassivePassive))};
