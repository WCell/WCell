...
namespace WCell.RealmServer.RacesClasses
{
    ...
    {
        /// <summary>
        /// Creates a new <see cref="Priest" /> object with the given base health/power values.
        /// </summary>
        ...
        {
            return (intellect / 80f) + /*(Spell Critical Strike Rating/22.08)*/ +1.24f;
        }
...
// TODO:  (tobz) - add skill/spell crap
            //base.AddSpell((ushort)585, 4);
            //base.AddSpell((ushort)2050, 3);
            //base.AddSpell(SPELLSKILL.SHOOT, 2);
            //base.AddSkill((ushort)0, (ushort)613, 1, 1);
            //base.AddSkill((ushort)0, (ushort)56, 1, 1);
            //base.AddSkill((ushort)0, (ushort)78, 1, 1);
