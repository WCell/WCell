...
namespace WCell.RealmServer.RacesClasses
{
    ...
    {
        /// <summary>
        /// Creates a new <see cref="Shaman" /> object with the given base health/power values.
        /// </summary>
        ...
        public override void InitializeStartingPlayer(Character character)
        {
            ...
            //base.AddSpell((ushort)403, 2);
            //base.AddSpell((ushort)331, 3);
            //base.AddSpell(SPELLSKILL.BLOCK);
            //base.AddSkill((ushort)0, (ushort)375, 1, 1);
            //base.AddSkill((ushort)0, (ushort)373, 1, 1);
