...
namespace MPQNav.MPQ
{
    public class TerrainManager
    {
        ...
        private readonly ADTManager _adtManager;
        public ADTManager ADTManager
        {
        ...
        public TerrainManager(string baseFileDirectory, ContinentType internalMapName, int mapId)
        {
            _mapId = mapId;
